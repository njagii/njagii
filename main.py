# Importing the modules for the game
import random
import sys
import pygame
from pygame.locals import *
import asyncio
from desktop_notifier import DesktopNotifier  # Module to give a desktop notification
notify = DesktopNotifier()

# Showing a desktop notification to invite the user to the gme before it starts
# Creating a function for the notification
async def main():
    n = await notify.send(title="Welcome to Flappy Bird", message="Game created by Victor Njagi @16")
...
# Setting the game's variables
window_width = 600
window_height = 499

# setting the height and width of the windows
window = pygame.display.set_mode((window_width, window_height))
elevation = window_height * 0.8
game_images = {}
# How fast the game will run
framepersecond = 32
# Getting the images for the game
...
if __name__ == "__main__":
	...
	pygame.display.set_caption('Flappy Bird Game by Victor')
	...
	while True:
		...
		while True:
			for event in pygame.event.get():
				...
				# if user doesn't press any key nothing will happen
				else:
					window.blit(game_images['background'], (0, 0))
